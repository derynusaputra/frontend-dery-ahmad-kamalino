...
import chat from '../../../assets/images/icons/messenger.png';
import profile from '../../../assets/images/icons/usename.png';
                    ...
                    return(
                        <View style={styles.tabItem} key={index}>
                            ...
                            >
                                ...
                                />
                                <Text style={{...FONTS.fontSm,...FONTS.fontTitle,color:isFocused ? colors.title : colors.text}}>{label}</Text>
                            </TouchableOpacity>
                        </View>
                    )
                })}
