...
const PostCard = ({ id, name, profileimage, date, postimage, like, comment, posttitle, posttag, sheetRef, optionSheet, hasStory, reelsvideo, caption, background, visibleBoxes }) => {
            ...
            <View style={{ paddingHorizontal: 15, paddingBottom: 20, paddingRight: 5 }}>
                ...
                <View style={{ marginTop: 5 }}>
                    <View style={{ paddingRight: 35 }}>
                        <Text numberOfLines={isShow ? null : 2} style={{ ...FONTS.fontRegular, color: colors.title, fontSize: 13 }}>{posttitle}</Text>
                        {isShow === false &&
                            <TouchableOpacity
