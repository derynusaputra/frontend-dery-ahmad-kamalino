...
const Reelsitem = ({ like, comment, save, send, image, text, music, holder, sheetRef, reelsvideo, hasStory }) => {
      ...
      <View style={{flex:1,backgroundColor:'#000'}}>
        ...
        <View style={{position:'absolute',bottom:20,left:20,paddingRight:120}}>
            ...
            <View style={{marginTop:20}}>
                <Text numberOfLines={isShow ? null : 1} style={{ ...FONTS.fontRegular, color: COLORS.white, fontSize: 12 }}>{text}</Text>
                {isShow === false &&       
                    <TouchableOpacity
