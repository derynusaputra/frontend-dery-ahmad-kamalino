...
const Item = ({ title, image, time, comment, like, commentNumber, counter, id, replies, moresheet, hasStory, navigation, theme }) => {
    ...
    return (
        ...
        <View
            style={[GlobalStyleSheet.container,{marginTop:0}]}
        >
