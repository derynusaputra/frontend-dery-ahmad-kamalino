...
const ProfileDetail = ({ route }) => {
  ...
  return (
    ...
    >
      <Header leftIcon={"back"} titleLeft />
      <ScrollView>
        <View style={GlobalStyleSheet.container}>
          <View style={{ marginBottom: 15, marginHorizontal: -5 }}>
            ...
            >
              ...
              />
              <Text style={{ ...FONTS.fontSm, color: COLORS.white, top: -1 }}>
                Recently active
              </Text>
            </View>
          </View>
          <View style={{ paddingHorizontal: 8 }}>
            ...
            >
              Just moved back to jakarata after living at India for 10+ years.
              Di luar terlifiat cenger - center di dalam.
            </Text>
            <Text
              style={{
                ...FONTS.h6,
              ...
              {intrestData.map((data, index) => {
                return (
                  ...
                  >
                    ...
                    />
                    <Text
                      style={{ ...FONTS.font, color: colors.title, top: -1 }}
                    >
                      {data.title}
                    </Text>
                  </TouchableOpacity>
